...
export default function Home() {
    ...
    return (
        <main>
            {/* Hero Section */}
            <section style={{ padding: '6rem 0', background: 'radial-gradient(circle at center, #260000 0%, #050505 100%)', textAlign: 'center' }}>
                <div className="container">
                    <h1 style={{ fontSize: '4rem', marginBottom: '1.5rem', background: 'linear-gradient(to right, #ff0000, #990000)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', textShadow: '0 0 20px rgba(255, 0, 0, 0.3)', fontWeight: '900' }}>
            ...
            <section className="container" style={{ marginBottom: '4rem' }}>
                <div className="card" style={{ background: 'linear-gradient(135deg, #990000 0%, #ff0000 100%)', color: '#fff', padding: '3rem', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
